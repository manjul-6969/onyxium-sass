...
const CircleWrapperLeft = (props: Props) => {
  return (
    <div className="circle-wrapper left group">
      <div className="absolute -inset-0.5 bg-[#91eae4] rounded-full blur-2xl opacity-70 group-hover:opacity-100 transition duration-100 group-hover:duration-200 animate-tilt"></div>

...
const CircleWrapperLeft = (props: Props) => {
  return (
    <div className="circle-wrapper left group">
      <div className="absolute -inset-0.5 animate-tilt rounded-full bg-[#91eae4] opacity-70 blur-2xl transition duration-100 group-hover:opacity-100 group-hover:duration-200"></div>
...
export default CircleWrapperLeft;
